    ...
    factories.each do |factory|
      ...
      unless result.blank?
        ...
        MthPdtRpt.transaction do
          ...
          if rpt.save!
            MonthBod.create!(:mth_pdt_rpt => rpt)
            MonthCod.create!(:mth_pdt_rpt => rpt)
            MonthTp.create!(:mth_pdt_rpt => rpt)
            MonthTn.create!(:mth_pdt_rpt => rpt)
            MonthNhn.create!(:mth_pdt_rpt => rpt)
            MonthSs.create!(:mth_pdt_rpt => rpt)
            MonthPower.create!(:mth_pdt_rpt => rpt)
            MonthMud.create!(:mth_pdt_rpt => rpt)
            MonthMd.create!(:mth_pdt_rpt => rpt)
            MonthFecal.create!(:mth_pdt_rpt => rpt)
          end
        end
      end
