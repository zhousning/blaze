...
@rcws  = Factory.create!(:area => "任城区",     :name => "任城污水处理厂",     :company => @renc, :lnt => 116.648154, :lat => 35.471726)
@bhws  = Factory.create!(:area => "太白湖新区", :name => "北湖污水处理厂",     :company => @beih, :lnt => 116.563934, :lat => 35.302149)
@jxws  = Factory.create!(:area => "嘉祥县",     :name => "嘉祥污水处理厂",     :company => @jiax, :lnt => 116.344578, :lat => 35.397421)
@qfyw  = Factory.create!(:area => "曲阜市",     :name => "曲阜第一污水处理厂", :company => @qufu, :lnt => 116.970989, :lat => 35.583201)
@qfsw  = Factory.create!(:area => "曲阜市",     :name => "曲阜第三污水处理厂", :company => @qufu, :lnt => 116.910627, :lat => 35.560928)
@wsfd  = Factory.create!(:area => "汶上县",     :name => "汶上佛都污水处理厂", :company => @wens, :lnt => 116.477282, :lat => 35.682433)
@wsqq  = Factory.create!(:area => "汶上县",     :name => "汶上清泉污水处理厂", :company => @wens, :lnt => 116.374719, :lat => 35.744584)
@wsqy  = Factory.create!(:area => "汶上县",     :name => "汶上清源污水处理厂", :company => @wens, :lnt => 116.480951, :lat => 35.712144)
@yzws  = Factory.create!(:area => "兖州区",     :name => "兖州污水处理厂",     :company => @yanz, :lnt => 116.781921, :lat => 35.510729)
@yzsw  = Factory.create!(:area => "兖州区",     :name => "兖州第三污水处理厂", :company => @yanz, :lnt => 116.781921, :lat => 35.510729)
@yzdy  = Factory.create!(:area => "兖州区",     :name => "兖州大禹污水处理厂", :company => @yanz, :lnt => 116.918884, :lat => 35.457138)
@zcdy  = Factory.create!(:area => "邹城市",     :name => "邹城第一污水处理厂", :company => @zouc, :lnt => 116.944881, :lat => 35.384207)
@zcde  = Factory.create!(:area => "邹城市",     :name => "邹城第二污水处理厂", :company => @zouc, :lnt => 116.918884, :lat => 35.457138)
@zcds  = Factory.create!(:area => "邹城市",     :name => "邹城第三污水处理厂", :company => @zouc, :lnt => 116.892618, :lat => 35.369115)
@dsmt  = Factory.create!(:area => "金乡县",     :name => "达斯玛特污水处理厂", :company => @jinx, :lnt => 116.33235,  :lat => 35.095662)
